...
public class ChaseState : IEnemyState
{
	...
	public void StateUpdate ()
	{
		...
		} else if (enemy.target != null && !enemy.InMeleeRange)
		{
			LookAtTarget ();
			enemy.Move ();
		} else if (enemy.target != null && enemy.InMeleeRange && NewPlayer.Instance.isStunned)
		{
			enemy.Move ();
		}
	...
	public void OnTriggerEnter2D (Collider2D other)
	{
		...
		//Debug.Log (col.name);
		if (other.gameObject.tag == "Player" && NewPlayer.Instance.isStunned && enemy.target != null)
		{
